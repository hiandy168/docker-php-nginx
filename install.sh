...
wget -c --no-check-certificate ${REMOTE_PATH}/nginx-init -O /etc/init.d/nginx
wget -c --no-check-certificate ${REMOTE_PATH}/nginx.conf -O ${WEBSERVER_INSTALL_DIR}/conf/nginx.conf
wget -c --no-check-certificate ${REMOTE_PATH}/rewrite.tar.gz -P ${WEBSERVER_INSTALL_DIR}/conf/
tar -zxvf ${WEBSERVER_INSTALL_DIR}/conf/rewrite.tar.gz && unlink ${WEBSERVER_INSTALL_DIR}/conf/rewrite.tar.gz
